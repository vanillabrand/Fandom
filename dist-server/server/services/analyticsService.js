...
export class AnalyticsService {
     ...
     */
    async getUserUsageTrends(userId, months = 3) {
    ...
    async getUserBenchmark(userId) {
        ...
        const allUsersStats = await Promise.all(activeUsers.map(async (user) => {
